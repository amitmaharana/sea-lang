...
public class SeaExecutor {
    ...
    public void execute() throws ArithmeticException, VariableNotDeclaredException, VariableAlreadyDefinedException, LogicalOperatorException {
    ...
    private boolean checkIfAlreadyDefined(String variableName) {
        return mIntegerMap.containsKey(variableName) || mBooleanMap.containsKey(variableName) || mStringMap.containsKey(variableName);
    }
